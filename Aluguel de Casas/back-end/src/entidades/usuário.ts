...
export enum Perfil { MORADORADICIONAL = "morador adicional", INQUILINO = "inquilino" };
...
cor_tema: string;
@OneToOne(() => Inquilino, (inquilino) => inquilino.usuário)
inquilino: Inquilino;
@OneToOne(() => MoradorAdicional, (moradoradicional) => moradoradicional.usuário)
aluno: MoradorAdicional;
@CreateDateColumn()
data_criação: Date;
}